...
public interface EventsMapper {
    ...
    io.zenwave360.example.delivery.core.domain.events.DeliveryStatusUpdated asDeliveryStatusUpdated(
            OrderStatusUpdated input);

    io.zenwave360.example.delivery.core.domain.events.DeliveryStatusUpdated asDeliveryStatusUpdated(String id,
