...
import io.zenwave360.example.orders.core.domain.OrderItemInput;
...
public interface EventsMapper {
    ...
    OrderItem aOrderItem(OrderItemInput orderItem);

    List<OrderItem> asOrderItemList(List<OrderItemInput> orderItems);
    ...
    @Mapping(source = "id", target = "orderId")
    OrderStatusUpdated orderStatusUpdated(io.zenwave360.example.orders.core.domain.events.OrderStatusUpdated payload);
}
